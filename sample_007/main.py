...
from src.preview.live_preview import LivePreview
...
def main():
    ...
    preview = LivePreview(stop_event=stop_event, render_interval_sec=1.0)
    ...
    workers = [
        (
            ...
            lambda: ni_adc.stream_to_csv(
                ...
                preview_listener=lambda payload: preview.publish(
                    modality="ni",
                    payload=payload,
