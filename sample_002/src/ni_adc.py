...
if __name__ == "__main__":
    ...
    channel_configs = [
        ChannelConfig(ch="ai0", ch_label="Channel 0", terminal_config=TerminalConfiguration.RSE, voltage_range=(-5.0, 5.0)),
        ChannelConfig(ch="ai1", ch_label="Channel 1", terminal_config=TerminalConfiguration.RSE, voltage_range=(-5.0, 5.0)),
        ChannelConfig(ch="ai2", ch_label="Channel 2", terminal_config=TerminalConfiguration.RSE, voltage_range=(-5.0, 5.0)),
        ChannelConfig(ch="ai3", ch_label="Channel 3", terminal_config=TerminalConfiguration.RSE, voltage_range=(-5.0, 5.0)),
    ]
